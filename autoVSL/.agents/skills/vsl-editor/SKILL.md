...
The b-roll inventory lives in `banks/broll.jsonl` (schema: `.Codex/skills/prospector/references/output-schemas.md` §5). Before generating or sourcing new footage:
