...
The pipeline's research banks live in `banks/` (schemas: `.Codex/skills/prospector/references/output-schemas.md`). This layer feeds the stages — it does not change them.
