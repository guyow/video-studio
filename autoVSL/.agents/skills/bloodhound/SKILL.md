...
Write hooks and angles into the SAME banks as prospector — `banks/hooks.jsonl` and `banks/angles.jsonl` — using the schemas in `.Codex/skills/prospector/references/output-schemas.md` **verbatim**, with exactly two bloodhound-specific markers:
